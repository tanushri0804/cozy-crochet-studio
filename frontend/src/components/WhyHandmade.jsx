...
const reasons = [
  {
    ...
    description:
      "Every single stitch is crafted with genuine care and attention. Your purchase supports a real person's passion and livelihood.",
  ...
  },
  {
    ...
    title: "Slow Fashion",
    description:
      "We believe in quality over quantity. Each piece takes time to create, ensuring it will last for years and become a cherished keepsake.",
  ...
  },
  {
    ...
    description:
      "Handmade means less environmental impact. We use premium, eco-friendly materials that are gentle on our planet.",
  ...
  },
  {
    ...
    title: "Truly Unique",
    description:
      "No two handmade pieces are exactly alike. You're getting a one-of-a-kind creation that can't be found in any store.",
    color: "text-primary bg-blush-light",
  },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <FadeInSection className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            Here's why choosing handmade is a choice for quality, sustainability,
            and love.
          </p>
        </FadeInSection>
          ...
          {reasons.map((reason, index) => (
            <FadeInSection key={reason.title} delay={index * 100}>
              <div className="flex gap-5 p-6 rounded-2xl bg-card border border-border/50 shadow-soft hover:shadow-lifted transition-all duration-300 group">
                <div
                  className={`w-14 h-14 rounded-xl ${reason.color} flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300`}
                >
