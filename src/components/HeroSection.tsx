...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      {/* Background pattern */}
      <div className="absolute inset-0 stitch-pattern opacity-30" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <FadeInSection className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-blush-light/60 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium text-foreground">Made with love & care</span>
            </div>
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-lg mx-auto lg:mx-0">
              Every stitch tells a story. Discover unique, handcrafted crochet creations 
              made with premium yarn and endless love. Perfect for gifts that truly matter.
            </p>
          ...
          <FadeInSection delay={200} className="relative">
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-lifted">
                ...
                <div className="absolute bottom-6 left-6 bg-card/90 backdrop-blur-sm px-4 py-3 rounded-2xl shadow-soft">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-foreground">Made with love</span>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-sage rounded-full shadow-soft animate-float" style={{ animationDelay: "1s" }} />
            </div>
          </FadeInSection>
        </div>
      </div>
