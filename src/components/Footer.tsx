      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm">
              Handcrafted with love, one stitch at a time. Every creation is made with 
              premium yarn and endless care to bring warmth into your home.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Shop All", "Custom Orders", "About Me", "FAQ", "Shipping Info"].map((link) => (
                <li key={link}>
        ...
        <div className="border-t border-border/50 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground flex items-center gap-1">
            Made with <Heart className="w-4 h-4 text-primary fill-primary" /> and lots of yarn
          </p>
        </div>
      </div>
    </footer>
